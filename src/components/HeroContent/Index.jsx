  ...
  return (
    <>
      <div className="container">
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 animate__animated animate__fadeInLeft">
            <HeroH1>
              motion designer
              <p>
                <strong>Cynthia Rocumback</strong> <br />
                <span style={{color:'#979595'}}>Product designer specialising in UI design and design systems.</span> 
              </p>
            </HeroH1>
            <br/>
          ...
          <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 animate__animated animate__fadeInRight">
            <HeroH1>
              frontend dev
              <p>
                <strong>Carlos Anbreu</strong> <br />
                <span style={{color:'#979595'}}>Front end developer who writes clean, elegant and efficient
                code.</span>
              </p>
            </HeroH1>
            <br/>
